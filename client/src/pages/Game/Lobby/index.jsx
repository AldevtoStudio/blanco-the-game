...
import { updateRoomByCode } from '../../../services/room';
import './Lobby.scss';

const Lobby = (props) => {
  const { room, setRoom, isAdmin } = props;
      ...
      {isAdmin && (
        <div>
          ...
          <form onSubmit={handleChangeSettings}>
            ...
            <input type='checkbox' defaultChecked={room.settings.changeTheme} name='changeTheme' />
            <br />
